...
public class Example3Server {
    private static final Logger logger = Logger.getLogger(Example3Server.class.getName());
    private Server server;

    public static void main(String[] args) throws IOException, InterruptedException {
        final Example3Server server = new Example3Server();
        server.start();
