...
public class Example2Server {
    private static final Logger logger = Logger.getLogger(Example2Server.class.getName());
    private Server server;

    public static void main(String[] args) throws IOException, InterruptedException {
        final Example2Server server = new Example2Server();
        server.start();
